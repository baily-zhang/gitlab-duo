...
| 2 | Docs: document the OSC `9;4` terminal progress signals as a public contract | [MR gitlab-org/gitlab!250315](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/250315) · [draft notes](contributions/02-docs-mr-terminal-progress.md) | **Merged** 2026-08-17 (Technical Writing review by @idurham). Submitted 2026-08-15 via the gitlab-community fork |
